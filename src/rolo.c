...
// LOL initially it was time time to ctime in timestring
...
// changed to void ...... idk why i had int initially.
void locked_action ()
{
...

{
    ...
    //pathname is the name of the file whose accessibility you want to test. The how argument
    //indicates the access modes you want to test. The following symbols are defined in the unistd.h
    // header file for use in the how argument:
    ...
    if (! (rolofd = open(homedir(ROLODATA),O_RDONLY))) {
